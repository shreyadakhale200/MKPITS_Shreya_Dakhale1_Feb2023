...
job_id varchar(20),
salary dec(10,2),
commision_pct dec(10,2),
manager_id int,
dept_id int,
constraint e foreign key(dept_id) references department1(dept_id) 
);
insert into employee values(100,'Steven','King','SKING','515.123.4567','2003-06-17','AD_PRES',24000.00,0.00,0,90)
insert into employee values(101,'Neena','Kochhar','NKOCHHAR','515.123.4568','2005-09-21','AD_VP',17000.00,0.00,100,90)
insert into employee values(102,'Lex','De Haan','LDEHAAN','515.123.4569','2001-01-13','AD_VP',17000.00,0.00,100,90)
insert into employee values(103,'Alexander','Hunold','AHUNOLD','590.423.4567','2006-01-03','IT_PROG',9000.00,0.00,102,60)
insert into employee values(104,'Bruce','Ernst','BERNST','590.423.4568','2007-05-21','IT_PROG',6000.00,0.00,103,60)


insert into employee values(105,'David','Austin','DAUSTIN','590.423.4569','2005-06-25','IT_PROG',4800.00,0.00,103,60)
insert into employee values(106,'Valli','Pataballa','VPATABAL','590.423.4560','2006-02-05','IT_PROG',4800.00,0.00,103,60)
insert into employee values(107,'Diana      ','Lorentz   ','DLORENTZ','590.423.5567','2007-02-07','IT_PROG', 4200.0,0.00,103, 60)
insert into employee values(108,'Nancy      ','Greenberg ','NGREENBE','515.124.4569','2002-08-17','FI_MGR ',12008.0,0.00,101,100)
insert into employee values(109,'Daniel     ','Faviet    ','DFAVIET ','515.124.4169','2002-08-16','FI_ACCOUNT',9000.00,0.00,108,100)


insert into employee values(110,'John       ','Chen      ','JCHEN   ','515.124.4269','2005-09-28','FI_ACCOUNT',8200.00,0.00,108,100)
insert into employee values(111,'Ismael     ','Sciarra   ','ISCIARRA','515.124.4369','2005-09-30','FI_ACCOUNT',7700.00,0.00,108,100)
insert into employee values(112,'Jose Manuel','Urman     ','JMURMAN ','515.124.4469','2006-03-07','FI_ACCOUNT',7800.00,0.00,108,100)
insert into employee values(113,'Luis       ','Popp      ','LPOPP   ','515.124.4567','2007-12-07','FI_ACCOUNT',6900.00,0.00,108,100)
insert into employee values(114,'Den        ','Raphaely  ','DRAPHEAL','515.127.4561','2002-12-07','PU_MAN  ',11000.00,0.00,100,30)
insert into employee values(115,'Alexander  ','Khoo      ','AKHOO   ','515.127.4562','2003-05-18','PU_CLERK', 3100.00,0.00,114,30)


insert into employee values(116,'Shelli     ','Baida     ','SBAIDA  ','515.127.4563','2005-12-24','PU_CLERK', 2900.00,0.00,114,30)
insert into employee values(117,'Sigal      ','Tobias    ','STOBIAS ','515.127.4564','2005-07-24','PU_CLERK', 2800.00,0.00,114,30)
insert into employee values(118,'Guy        ','Himuro    ','GHIMURO ','515.127.4565','2006-11-15','PU_CLERK', 2600.00,0.00,114,30)
insert into employee values(119,'Karen      ','Colmenares','KCOLMENA','515.127.4566','2007-08-10','PU_CLERK', 2500.00,0.00,114,30)
insert into employee values(120,'Matthew    ','Weiss     ','MWEISS  ','650.123.1234','2004-07-18','ST_MAN  ', 8000.00,0.00,100,50)
insert into employee values(121,'Adam       ','Fripp     ','AFRIPP  ','650.123.2234','2005-04-10','ST_MAN  ', 8200.00,0.00,100,50)
insert into employee values(122,'Payam      ','Kaufling  ','PKAUFLIN','650.123.3234','2003-05-01','ST_MAN  ', 7900.00,0.00,100,50)


insert into employee values(123,'Shanta     ','Vollman   ','SVOLLMAN','650.123.4234','2005-10-10','ST_MAN  ', 6500.00,0.00,100,50),
...
insert into employee values(129,'Laura      ','Bissot    ','LBISSOT ','650.124.5234','2005-08-20','ST_CLERK',3300.00,0.00,121,50),
...
insert into employee values(139,'John       ','Seo       ','JSEO    ','650.121.2019','2006-02-12','ST_CLERK',2700.00,0.00,123,50),
...
insert into employee values(156,'Janette    ','King      ','JKING   ','011.44.1345.429268','2004-01-30','SA_REP',10000.00,0.35,146,80),
...
insert into employee values(173,'Sundita    ','Kumar     ','SKUMAR  ','011.44.1343.329268','2008-04-21','SA_REP', 6100.00,0.10,148,80),
...
insert into employee values(177,'Jack       ','Livingston','JLIVINGS','011.44.1644.429264','2006-04-23','SA_REP', 8400.00,0.20,149,80)

insert into employee values(178,'Kimberely  ','Grant     ','KGRANT  ','011.44.1644.429263','2007-05-24','SA_REP', 7000.00,0.15,149, 20)


insert into employee values(201,'Michael','Hartstein','MHARTSTE','515.123.5555','2004-02-17','MK_MAN',    13000.00,0.00,100, 20),
...
insert into employee values(186,'Julia      ','Dellinger ','JDELLING','650.509.3876','2006-06-24','SH_CLERK',3400.00,0.00,121,50),
...
insert into employee values(193,'Britney    ','Everett   ','BEVERETT','650.501.2876','2005-03-03','SH_CLERK',3900.00,0.00,123,50),
...
insert into locations values(1000,'1297 Via Cola di Rie','989','Rome','null','IT')
...
insert into locations values(1800,'147 Spadina Ave','75527','Toronto            ','Ontario         ',' CA')
insert into locations values(1900,'6092 Boxwood St','92875','Whitehorse','Yukon',' CA')
...
insert into locations values(2500,'Magdalen Centre,Oxford park','099908','Oxford             ','Oxford          ',' UK'),
(2600,'9702 Chester Road                       ','950293','Stretford          ','Manchester      ',' UK'),
(2700,'Schwanthalerstr. 7031                   ','80925     ','Munich             ','Bavaria         ',' DE'),
(2800,'Rua Frei Caneca 1360                    ','01307002 ','Sao Paulo          ','Sao Paulo       ',' BR'),
(2900,'20 Rue des Corps-Saints                 ','1730      ','Geneva             ','Geneve          ',' CH'),
(3000,'Murtenstrasse 921                       ','3095      ','Bern               ','BE              ',' CH'),
(3100,'Pieter Breughelstraat 837               ','30292   ','Utrecht            ','Utrecht         ',' NL'),
...
sp_rename 'job_greades', 'job_grades';
...
select e.first_name,e.last_name,d.dept_id,d.dept_name from department1 d inner join employee e on d.dept_id = e.dept_id
...
select e.first_name,e.last_name,d.dept_name,l.city,l.STATE_PROVINCE 
from employee e 
inner join department1 d on e.dept_id = d.dept_id 
	  join locations   l on d.location_id = l.LOCATION_ID
--table which is common among three tables put that table in front of from

SELECT E.first_name,E.last_name, 
   D.dept_name, L.city, L.STATE_PROVINCE
     FROM employee E 
      JOIN department1 D  
...
select e.first_name,e.last_name,e.last_name,e.salary,j.GRADE_LEVEL from employee e inner join job_grades j on 
...
--Sample table: employees
  select * from department1
  select * from employee
  select e.first_name,e.last_name,e.dept_id,d.dept_name from employee e inner join department1 d on e.dept_id = d.dept_id and e.dept_id in(80,40) order by e.first_name
...
select e.first_name,e.last_name,d.dept_id,l.city,l.state_province from department1 d join employee e on
d.dept_id = e.dept_id join locations l on d.location_id = l.LOCATION_ID where e.first_name like '%z%'
...
--Sample table: employees
  ...
  select e.first_name,e.last_name,d.dept_id,d.dept_name from employee e right outer join department1 d on e.dept_id = d.dept_id
...
select e.first_name,e.last_name,e.salary from employee e join employee e1 on e.salary < e1.salary where e1.employee_id = 182

select e.first_name,e.last_name,e.salary from employee e join employee e1 on e.salary < e1.salary and e1.employee_id = 182
...
select e.first_name as "Employee_id", m.first_name as "Manager_id" from employee e join employee m on e.employee_id = m.manager_id
